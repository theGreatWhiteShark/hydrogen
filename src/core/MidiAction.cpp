...
MidiActionManager::MidiActionManager() {
	...
	*/
	...
	m_actionMap.insert(std::make_pair("LOAD_NEXT_DRUMKIT", std::make_pair( &MidiActionManager::loadNextDrumkit, 0 ) ));
	m_actionMap.insert(std::make_pair("LOAD_PREV_DRUMKIT", std::make_pair( &MidiActionManager::loadPrevDrumkit, 0 ) ));
...
bool MidiActionManager::loadNextDrumkit( std::shared_ptr<Action>, Hydrogen* ) {
	...
	pController->setDrumkit( pNewDrumkit );
